...
Click NoItem De Lista Foi Que Criado
    ...
    Click Element    xpath=//*[@resource-id='com.ichi2.anki.debug:id/deckpicker_name' and @text='Teste3']

ClickLong NoItem De Lista Foi Que Criado
    Wait Until Element Is Visible    id=com.ichi2.anki.debug:id/deckpicker_name    timeout=20
    Long Press      xpath=//*[@resource-id='com.ichi2.anki.debug:id/deckpicker_name' and @text='Teste3']

Click NoItem No Good Button
    Click Element      id=com.ichi2.anki.debug:id/flashcard_layout_ease3    
...
Click no Show Card    
    Click Element    id=com.ichi2.anki.debug:id/flip_card


*** Test Cases ***
Deve Estudar cartões de um baralho
